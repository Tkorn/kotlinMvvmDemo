...
abstract class BaseViewModel<R: BaseRepository>(application: Application, repository: R,responseErrorListener: IResponseErrorListener): AndroidViewModel(application) {
